...
int find_smallest_number(const vector<int>&);
void largest_number(const vector<int>&);
int find_largest_number(const vector<int>&);
void find_number(const vector<int>&);
int find(const vector<int>&, int);
void clear_number(vector<int>&);
void quit();
...
void print_number(const vector<int> &numbers) {
    if (numbers.size() == 0)
...
void mean_of_number(const vector<int> &numbers) {
    if (numbers.size() == 0)
...
int find_smallest_number(const vector<int> &numbers) {
...
int find_largest_number(const vector<int> &numbers) {
...
void find_number(const vector<int> &numbers) {
    int target{};
    cout << "Enter the number to find: ";
    cin >> target;
    int times = find(numbers, target);
    if (times) 
        cout << target << " was found " << times << " times" << endl;
    else
...
void clear_number(vector<int> &numbers) {
    numbers.clear();
}
